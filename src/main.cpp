...
void send(String tmp)
{
  if (onoff_flag)
  {
    if (tmp == "AI_Smart_AC_121_B::temperature_up")
      temperature += 1;
    if (tmp == "AI_Smart_AC_121_B::temperature_down")
      temperature -= 1;
    if (tmp == "AI_Smart_AC_121_B::rhythm")
      rhythm += 1;
    if (tmp == "AI_Smart_AC_121_B::auto")
      function = 3;
    if (tmp == "AI_Smart_AC_121_B::breez")
      function = 2;
    if (tmp == "AI_Smart_AC_121_B::weak")
      function = 1;
    if (tmp == "AI_Smart_AC_121_B::strong")
      function = 0;
    if (rhythm > 1)
      rhythm = 0;
    if (temperature > 30)
    ...
    if (tmp == "AI_Smart_AC_121_B::power_onoff")
      firebase_search = "on_off";
